...
import com.whl.demo.config.auth.provider.GoogleUserInfo;
import com.whl.demo.config.auth.provider.KakaoUserInfo;
import com.whl.demo.config.auth.provider.NaverUserInfo;
...
public class PrincipalDetailsOAuth2Service extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if(provider!=null&&provider.equals("kakao")){
            ...
            Map<String, Object> resp = (Map<String, Object>)oAuth2User.getAttributes().get("response"); // oAuth2User.getAttributes() 에 response를 가져오는 변수

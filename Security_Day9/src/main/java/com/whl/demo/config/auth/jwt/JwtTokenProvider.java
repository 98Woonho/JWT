package com.whl.demo.config.auth.jwt;
...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider() throws SQLException, ClassNotFoundException {
    ...
    public TokenInfo generateToken(Authentication authentication) {
        ...
        // Access Token 생성
        Date accessTokenExpiresIn = new Date(now + 5 * 60 * 1000); // 60초후 만료
